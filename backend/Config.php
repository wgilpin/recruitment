...
return array(
    ...
    "Client_IDLogin"=>$Client_IDLogin,
    "Client_PassLogin"=>$Client_PassLogin,
    "Host"=>$Host,
    "dbName"=>$dbName,
    "dbPass"=>$dbPass,
    "Charset"=>$Charset,
    "EVEDBHost"=>$EVEDBHost,
    "EVEDBdbName"=>$EVEDBdbName,
    "EVEDBdbPass"=>$EVEDBdbPass,
    "EVEDBCharset"=>$EVEDBCharset,
    "EVEDBinventoryType"=>$EVEDBinventoryType,
    "EVEDBstations"=>$EVEDBstations,
    "Client_Basic"=>$Client_Basic,
    "Client_BasicLogin"=>$Client_BasicLogin,
    "daysCharacter"=>$daysCharacter,
    "daysCorporation"=>$daysCorporation,
    "daysAlliance"=>$daysAlliance,
    "daysStructure"=>$daysStructure,
    "scopes"=>$scopes
        );
}