...
switch ($level) {
    case 4:                             //Recruiter
        ...
        // list requested help per recruiter if claimed by senior then show by who                   done.
        // archive
        break;
    case 5:                             //Senior Recruiter
        //list requested help all                                                                   done.

        //list claimed request help                                                                 done.

        //list claimable applicants                                                                 done.
