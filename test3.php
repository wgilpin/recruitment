...
$keyArray = array("skills", "type_id", "name", "description", "multiplier", "group_id","primaryAttribute","secondaryAttribute");
//$cache->insertUpdate($pullcase->_Return(), $keyArray);
dprintr($cache->skillsSelectQuery(array('3300' => "3300")));
//dprintr($test);