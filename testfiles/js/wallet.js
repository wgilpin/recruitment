...
var Wallet = function (_Base) {
  ...
  function Wallet(selector) {
    _classCallCheck(this, Wallet);

    var dom = $(selector).parent().find('.content');

    var _this = _possibleConstructorReturn(this, (Wallet.__proto__ || Object.getPrototypeOf(Wallet)).call(this, 'wallet', dom));
  ...
  _createClass(Wallet, [{
    ...
    value: function click() {
      _get(Wallet.prototype.__proto__ || Object.getPrototypeOf(Wallet.prototype), 'onClick', this).call(this, {}, this.onLoaded.bind(this));
    }
  }, {
    key: 'onLoaded',
    value: function onLoaded(result) {
      ...
      var transactions = result.info.map(function (el) {
        el.threeParty = el.first_party_id.id == window.global.myName ? el.second_party_id.id : el.first_party_id.id;
        return el;
      });
